...
class ClassmatService {
  ...
  static Future<Map<String, dynamic>> getClasses() async {
    try {
      ...
      final url = Uri.parse('${Constants.baseUrl}/Classmat/classes');
  ...
  static Future<Map<String, dynamic>> updateClasse(int id, Map<String, dynamic> data) async {
    try {
      final token = await _getToken();
      final url = Uri.parse('${Constants.baseUrl}/Classmat/classes/$id');
  ...
  static Future<Map<String, dynamic>> getMatieres() async {
    try {
      final token = await _getToken();
      final url = Uri.parse('${Constants.baseUrl}/Classmat/matieres');
  ...
  static Future<Map<String, dynamic>> updateMatiere(int id, Map<String, dynamic> data) async {
    try {
      final token = await _getToken();
      final url = Uri.parse('${Constants.baseUrl}/Classmat/matieres/$id');
