// lib/screens/admin_forgot_password_page.dart
...
class _AdminForgotPasswordPageState extends State<AdminForgotPasswordPage> {
  ...
  Future<void> _sendCode() async {
    ...
    final response = await AdminAuthService.forgotPassword(_emailController.text);
    ...
    if (response['success'] == true) {
      ...
      _showError(response['message'] ?? 'Erreur lors de l\'envoi');
    }
  }
  ...
  Future<void> _verifyCode() async {
    ...
    final response = await AdminAuthService.verifyCode(
    ...
    if (response['success'] == true) {
      ...
      _showError(response['message'] ?? 'Code invalide');
    }
  }
  ...
  Future<void> _resetPassword() async {
    ...
    final response = await AdminAuthService.resetPassword(
      _emailController.text,
      _codeController.text,
    ...
    if (response['success'] == true) {
      ...
      _showError(response['message'] ?? 'Erreur lors de la réinitialisation');
    }
  }
